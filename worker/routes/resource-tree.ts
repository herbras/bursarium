...
const resourceTree = {
  ...
  trading: {
    ...
    company: { ':code': { daily: 'GET limit, offset, total?', summary: 'GET limit, offset, total?' } }
  },
  data: {
  ...
  ksei: {
    ...
    'similar/:code': 'GET limit — tickers with most similar shareholder profile (cosine sim on 18-D type vector)'
  }
}

export const resourceRouter = new Hono<{ Bindings: Env }>()
